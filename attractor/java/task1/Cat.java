...
final class Cat {
    ...
    public static Comparator<Cat> byBreed = Comparator.comparing(Cat::getBreed);
    public static Comparator<Cat> byNameAndAge = Comparator
            .comparing(Cat::getName)
            .thenComparingInt(Cat::getAge);

    public static Predicate<Cat> byColor(Color color) {
        return cat -> cat.getColor() != color;
    }

    public static Predicate<Cat> byNameLength(int length) {
        return cat -> cat.getName().length() != length;
    }
